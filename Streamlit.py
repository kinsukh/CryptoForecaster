...
#         # Plotting directly in Streamlit
#         predictor.plot_results(y_true, y_pred, ticker)
#         st.pyplot()  # Show the plot in the app
...
#             progress_bar.progress((i + 1) / len(history.history['loss']))
...
#         st.pyplot()  # Show the plot in the app
#         st.success("Prediction completed. Check the plots directory for visualization.")
#     else:
#         predictor.run()
...
#         # Assuming you have a plot function in RandomForestPredictor
#         rf_predictor.plot_results(y_true, y_pred)
#         st.pyplot()  # Show the plot in the app
#     else:
...
# st.title("Cryptocurrency & Stock Price Predictor")
